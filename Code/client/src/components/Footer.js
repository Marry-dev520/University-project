        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
              Empowering your team with AI-driven analytics and seamless project
              allocation.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-lg px-4 py-2.5 text-sm outline-none focus:border-slate-400 focus:ring-1 focus:ring-slate-400 transition-all"
              />
              <button className="w-full bg-slate-900 hover:bg-slate-800 text-white text-sm font-medium py-2.5 rounded-lg transition-colors">
                Subscribe
              </button>
            </div>
          </div>
